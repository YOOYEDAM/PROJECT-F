...
・IntelliJ IDEA、PhpStorm 2017.1 差分訳追加
...
・IDEA、Android Studio で動作しなくなっていた問題を修正
...
・Apache Directory Studio、Aptana、DBeaver、Eclipse、Eclipse Class Decompiler、EGit、FindBugs、InstaSearch、m2e、
　MoreUnit、Mylyn、PDT、Tomcat Launcher、WTP の差分訳追加・修正
・Eclipse 次バージョン Oxygen の暫定スプラッシュ追加

1.7.8 - 2016.08.05

・XML エディターの設計タブを右クリック「置換」でメニューの属性名が翻訳される問題を修正
・エディターのタブが翻訳される問題を修正
・Builldship、Eclipse、m2e、WTP の差分訳追加・修正
...
・Eclipse、EGit、Autodetect Encoding の差分訳追加・修正
...
・Buildship、Eclipse、EGit、Autodetect Encoding の差分訳追加・修正

1.7.3 - 2016.07.18

・Buildship、Eclipse、EGit、Glance、InstaSearch、WTP の差分訳追加・修正
・Pleiads 高速化、メモリ使用量削減、翻訳リソース効率化
・[#36430] deprecated 警告対応

1.7.2 - 2016.07.03

・Autodetect Encoding、LogViewer の差分訳追加・修正
・\u00A0 も空白として句点分割するように対応
・拡張ポイント XML 定義の翻訳を label 属性のみとなるように修正

1.7.1 - 2016.06.24

・Eclipse 4.6、JAutodoc、m2e、更新マネージャーの差分訳追加・修正
