...
public class TestListSubjectDao extends Dao {
	...
	private List<TestListEmployee> postFilter(ResultSet rSet) throws Exception {
		...
		while (rSet.next()) {
			// ユーザIDを取得
			String userId = rSet.getString("st_no");
	 ...
	 * @throws Exception
	 */
	public List<TestListEmployee> filter(int entYear, String classNum, Subject subject, Company school) throws Exception {
