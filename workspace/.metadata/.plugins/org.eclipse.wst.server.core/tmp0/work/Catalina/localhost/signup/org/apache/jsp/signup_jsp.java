 ...
 * Generated at: 2025-02-07 03:28:40 UTC
...
return;
    ...
    try {
      ...
      out.write("            let passPattern = /(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}/;\r\n");
      out.write("            let emailPattern = /^[^\\s@]+@[^\\s@]+\\.[^\\s@]+$/;\r\n");
      out.write("\r\n");
      out.write("            if (!idPattern.test(userId)) {\r\n");
      out.write("                alert(\"アルファベットと数字を含めて作成してください。\");\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            if (!passPattern.test(password)) {\r\n");
      out.write("                alert(\"大文字と小文字、数字、特殊記号を含めて作成してください。\");\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
      out.write("            if (!emailPattern.test(email)) {\r\n");
      out.write("                alert(\"有効な電子メール形式ではありません。\");\r\n");
      out.write("                return false;\r\n");
      out.write("            }\r\n");
      out.write("\r\n");
