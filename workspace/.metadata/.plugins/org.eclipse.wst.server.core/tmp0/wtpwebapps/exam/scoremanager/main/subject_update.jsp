		...
		<section class="me-4">
			<h2 class="h3 mb-3 fw-norma bg-secondary bg-opacity-10 py-2 px-4">科目情報変更</h2>
				<form action = "SubjectUpdateExecute.action" method="post">
					<div class="mb-3">
						<label class="form-label" for="subject-cd-update">科目コード</label>
							<input readonly class="form-control-plaintext ms-3" type="text"
							id="subject-cd-update" name="cd" value="${cd}" />
					</div>
					<div class="mb-3">
						<label class="form-label" for="subject-name-update">科目名</label>
							<input class="form-control" type="text" id="subject-name-update"
